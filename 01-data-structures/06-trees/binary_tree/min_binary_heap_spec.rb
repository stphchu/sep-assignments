...
RSpec.describe MinBinaryHeap, type: Class do
  ...
  describe "#insert(data)" do
    it "properly inserts a new node as a left child" do
      ...
      expect(root.left.title).to eq "Arrival"
    end
    ...
    it "properly inserts a new node as a left-left child" do
      ...
      expect(root.left.left.title).to eq "The Favourite"
    end
    ...
    it "properly inserts a new node as a left-right child" do
      ...
      expect(root.left.right.title).to eq "Moonlight"
    end

    it "properly inserts a new node as a right child" do
      tree.insert(root, black_panther)
      tree.insert(root, braidsmaids)
      expect(root.right.title).to eq "Braidsmaids"
    end
    ...
    it "properly inserts a new node as a right-left child" do
      ...
      tree.insert(root, the_favourite)
      tree.insert(root, moonlight)
      expect(root.right.left.title).to eq "Moonlight"
    end
